...
export default function Profile() {
  ...
  const getProfile = async () => {
    ...
    let response = await fetch("https://sudomovies-backend.onrender.com/api/auth/getuser", {
      method: "GET",
      headers: headersList,
    });
  ...
  const addtokens =async () => {
    let headersList = {
     ...
     let response = await fetch("https://sudomovies-backend.onrender.com/api/tokens/addtoken/50", { 
       method: "PUT",
       headers: headersList
     });
